 ...
 */
public abstract class PCHostSelection extends PCAdded {

    private HostSelectionPolicy hostSelectionPolicy;

    public PCHostSelection(List<? extends ContainerHost> hostList, PowerContainerVmSelectionPolicy vmSelectionPolicy,
