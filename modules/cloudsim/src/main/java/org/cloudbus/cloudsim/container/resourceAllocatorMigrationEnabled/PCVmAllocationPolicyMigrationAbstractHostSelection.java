 ...
 */
public class PCVmAllocationPolicyMigrationAbstractHostSelection extends PCVmAllocationPolicyMigrationAbstract {
     ...
     */
    public PCVmAllocationPolicyMigrationAbstractHostSelection(List<? extends ContainerHost> hostList, PowerContainerVmSelectionPolicy vmSelectionPolicy, HostSelectionPolicy hostSelectionPolicy, double OlThreshold, double UlThreshold) {
